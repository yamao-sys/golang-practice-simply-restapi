...
var (
	userAllColumns            = []string{"id", "uuid", "name", "email", "password", "created_at", "updated_at"}
	userColumnsWithoutDefault = []string{"uuid", "name", "email", "password", "created_at", "updated_at"}
